/* Knob.h (2023.25 knob hello world based off liteswarm another-try branch)
** https://github.com/counterbeing/liteswarm/blob/ac99ed2ccc8ac34a3386412081136a2e9588ed9d/src/Knob.h
** 
*/

#pragma once
// #include "DebugLog.h"  // vestigal?
#include "KnobSettings.h"
// #include "config.h"    // vestigal?
...
class Knob {
 ...
 public:
  ...
  void setup() { encoder.attachHalfQuad(rotary1, rotary2); }
};